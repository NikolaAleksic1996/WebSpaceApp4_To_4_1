...
class __TwigTemplate_27f0649dd4bd0884c8e8b88c18136857fc02ff356e4a48bb0306960e46b9ee21 extends \Twig\Template
{
    private $source;
...
";
                ...
                <div class=\"row spacepurplebg white\">
                    <div class=\"col-md-2 no-pad\">
                        <div class=\"user-image\">
                            <img src=\"";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 18, $this->source); })()), "user", [], "any", false, false, false, 18), "avatarUrl", [], "any", false, false, false, 18), "html", null, true);
    ...
    {
        return array (  140 => 27,  134 => 25,  132 => 24,  128 => 23,  120 => 18,  112 => 12,  103 => 11,  91 => 8,  85 => 6,  76 => 5,  58 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {# <h1>Manage your account {{ app.user.firstName }}</h1> {# zato sto je app globalna promenjiva #}
{% endblock %}
", "account/index.html.twig", "/home/nikola/Desktop/Project/WebSpaceApp4_To_4_1/templates/account/index.html.twig");
    }
}
