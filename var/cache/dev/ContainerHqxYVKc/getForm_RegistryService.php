...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Form\\ArticleFormType' => function () {
    return ($this->privates['App\Form\ArticleFormType'] ?? $this->load('getArticleFormTypeService.php'));
}, 'App\\Form\\UserRegistrationFormType' => function () {
    return ($this->privates['App\Form\UserRegistrationFormType'] ?? ($this->privates['App\Form\UserRegistrationFormType'] = new \App\Form\UserRegistrationFormType()));
}, 'App\\Form\\UserSelectTextType' => function () {
    return ($this->privates['App\Form\UserSelectTextType'] ?? $this->load('getUserSelectTextTypeService.php'));
...
}]), ['Symfony\\Component\\Form\\Extension\\Core\\Type\\TextareaType' => new RewindableGenerator(function () {
    yield 0 => ($this->privates['App\Form\TypeExtension\TextareaSizeExtension'] ?? ($this->privates['App\Form\TypeExtension\TextareaSizeExtension'] = new \App\Form\TypeExtension\TextareaSizeExtension()));
