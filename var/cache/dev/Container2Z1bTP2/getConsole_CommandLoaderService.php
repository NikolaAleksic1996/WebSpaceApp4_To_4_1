...
}, 'maker.auto_command.make_test' => function (): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
    return ($this->privates['maker.auto_command.make_test'] ?? $this->load('getMaker_AutoCommand_MakeTestService.php'));
